      ...
      <main className="w-full max-w-5xl mx-auto px-6 py-12 flex flex-col items-center text-center space-y-12">
        ...
        <div className="max-w-3xl space-y-4">
          <h1 className="font-serif text-4xl sm:text-6xl font-extrabold text-[#004349] leading-tight">
            Belajar Bahasa Isyarat Jadi Lebih <span className="underline decoration-[#ffbe4f] decoration-wavy decoration-4">mudah & Seru</span>
          </h1>
          <p className="text-sm sm:text-base text-[#3f484a] max-w-xl mx-auto leading-relaxed font-medium">
            Kuasai gestur jemari Huruf,Angka dan kata secara terstruktur lewat modul visual, latihan kuis interaktif, dan pencatatan jurnal progress.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full pt-8 text-left">
          ...
          <div className="bg-[#faf3e6] border-2 border-[#004349] rounded-2xl p-6 shadow-[5px_5px_0px_0px_#004349] space-y-3 relative overflow-hidden">
            ...
            <h3 className="font-serif text-lg font-bold text-[#004349]">Modul Visual</h3>
            <p className="text-xs text-[#3f484a] leading-relaxed font-medium">
              Kumpulan Huruf,Angka dan kosa kata isyarat BISINDO dilengkapi instruksi visual yang mudah dipahami.
            </p>
          </div>
          ...
          <div className="bg-[#faf3e6] border-2 border-[#004349] rounded-2xl p-6 shadow-[5px_5px_0px_0px_#004349] space-y-3 relative overflow-hidden">
            ...
            <p className="text-xs text-[#3f484a] leading-relaxed font-medium">
              Uji pemahaman hafalan gerakan tanganmu lewat sistem kuis pilihan ganda yang interaktif dan dinamis.
            </p>
          </div>
          ...
          <div className="bg-[#faf3e6] border-2 border-[#004349] rounded-2xl p-6 shadow-[5px_5px_0px_0px_#004349] space-y-3 relative overflow-hidden">
            ...
            <p className="text-xs text-[#3f484a] leading-relaxed font-medium">
              Pantau konsistensi belajarmu dengan sistem streak dan riwayat nilai kuis yang tersimpan aman.
            </p>
          </div>
        ...
        <div className="w-full bg-[#faf3e6] border-2 border-[#004349] rounded-3xl p-6 sm:p-8 shadow-[6px_6px_0px_0px_#004349] text-left relative overflow-hidden">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b-2 border-[#004349]/20 pb-4 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-serif text-lg font-bold text-[#004349]">AI Camera Detector</h3>
          ...
          <p className="text-xs sm:text-sm text-[#3f484a] leading-relaxed mb-4 font-medium">
            SGL Learning ingin mengembangkan model Machine Learning berbasis kamera web untuk mendeteksi posisi lekukan jemari tanganmu secara <span className="font-bold text-[#004349]">real-time</span> saat berlatih.
          </p>
